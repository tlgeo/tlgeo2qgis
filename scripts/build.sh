...
# Detect OS and set QGIS plugin paths (supports QGIS3 and QGIS4)
QGIS_PLUGIN_DIRS=()
if [[ "$OSTYPE" == "darwin"* ]]; then
  # macOS
  QGIS_PLUGIN_DIRS+=("$HOME/Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins")
  QGIS_PLUGIN_DIRS+=("$HOME/Library/Application Support/QGIS/QGIS4/profiles/default/python/plugins")
elif [[ "$OSTYPE" == "linux-gnu"* ]]; then
  # Linux
  QGIS_PLUGIN_DIRS+=("$HOME/.local/share/QGIS/QGIS3/profiles/default/python/plugins")
  QGIS_PLUGIN_DIRS+=("$HOME/.local/share/QGIS/QGIS4/profiles/default/python/plugins")
elif [[ "$OSTYPE" == "msys" || "$OSTYPE" == "cygwin" ]]; then
  # Windows (Git Bash / Cygwin)
  QGIS_PLUGIN_DIRS+=("$APPDATA/QGIS/QGIS3/profiles/default/python/plugins")
  QGIS_PLUGIN_DIRS+=("$APPDATA/QGIS/QGIS4/profiles/default/python/plugins")
fi
