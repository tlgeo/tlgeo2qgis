...
def format_to_html(text):
    ...
    # Escape HTML tags to prevent broken UI formatting
    text = text.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;")
    # Restore the essential thought tags for parsing
...
class MessageBubble(QWidget):
    ...
    def __init__(self, role, text="", parent=None):
        ...
        # Thinking frame (only for Bot assistant)
...
class GeoAIWidget(QWidget):
    """
    GeoAI Chat UI Widget. Connects directly to the websocket /ws/ui endpoint.
    """
